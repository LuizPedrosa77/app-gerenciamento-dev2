  ...
  return (
    <div className="w-full h-screen flex items-center justify-center main-content-bg p-4">
      <div className="flex flex-col items-center justify-center max-w-md">
        ...
        >
          As APIs para automação estão sendo desenvolvidas. Em breve será possível conectar sua corretora, MT5, MT4, cTrader, Tradovate e outros sistemas diretamente ao Gustavo Pedrosa FX.
        </p>
